...
public class GetOwnedConcertsOfUserTest extends AbstractConcertsControllerTestSetup{
    ...
    public void testGetOwnedConcertsOfUser() throws Exception{
        ...
        when(concertService.getConcertsOwnedOfUser(userName)).thenReturn(concertDtoTestCollection);
